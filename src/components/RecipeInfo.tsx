            ...
            <>
                <div className="flex items-end justify-center flex-col h-full">
                    ...
                    <p className="w-1/2  mt-14 border-l-4 pl-3 border-primary font-light">
                        ...
                        a doladila, ale základ je vlastně úplně stejnej, jako na tu polívku. Pak k pečený zelenině
                        akorát do mixéru místo vývaru přihodíte ricottu a vznikne vám božská a delikátní omáčka.
                    </p>
                </div>
